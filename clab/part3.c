...
// It assigns "false" (the zero value) to elements at array indexes 2*p, 3*p, 4*p,.....
// For example, given arr=[1, 1, 1, 1, 1, 1], n = 5  and p = 2
...
// 
// For example, given arr with n=6
// the resulting sieve is arr=[0, 0, 1, 1, 0, 1] because indexes 2,3,5 correspond to primes
void
 ...
 * the function returns false.  For example, in the following code snippet:
 ...
 Then you can test if any of the prime numbers divide n and return the smallest one.
